...
class PropertyProgress extends Component {
  ...
  remove = k => {
    ...
    // this.props.brokeragePolicies.splice(k, 1);
    // files.splice(k, 1);
  ...
  handleSubmit = async (e) => {
    ...
    try {
      const { form } = this.props;
      // const payload = form.getFieldsValue(['constructionProgress', 'title', 'updatedAt']);
  ...
  render() {
    ...
    const {currentProperty, brokeragePolicies} = this.props;
        ...
        <Form onSubmit={this.handleSubmit}>
          ...
          <Row>
            <Col xs={24} lg={16} xl={12} style={{ paddingRight: "8px" }}>
              <Typography.Title level={4}>Tiến độ dự án</Typography.Title>

              <Form.Item className="constructionProgress">
                ...
                <Editor
                  content={currentProperty.constructionProgress || ''}
                />,
              )}
              </Form.Item>
            </Col>
            ...
            >
              ...
              <Typography.Title level={4}>Chính sách môi giới</Typography.Title>
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(PropertyProgress));

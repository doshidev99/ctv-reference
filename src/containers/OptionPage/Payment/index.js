...
class PaymentTable extends Component {
  ...
  save = async (form, key) => {
    try {
      ...
      await this.props.updateRecord("payment-methods", key, row);
      // await this.props.updateOnePayment(key, row);
      await this.props.retrieveData("payment-methods", { limit, skip }, true);
      this.setState({ editingKey: "" });
    } catch (error) {
  ...
  handleOk = async () => {
    ...
    try {
      ...
      await this.props.createRecord("payment-methods", payload);
      this.setState({
        visible: false,
      });
    } catch (error) {
      ...
      <Wrapper>
        <EditableContext.Provider value={this.props.form}>
          ...
          <Table
            ...
            dataSource={
              paymentMethods && paymentMethods.map((e) => ({ ...e, key: e.id }))
            }
...
const mapStateToProps = (state) => {
  return {
    paymentMethods: getListResourceData(state, "payment-methods"),
    total: getTotalResources(state, "payment-methods"),
    ...getFilters(state, "payment-methods"),

    loading: getLoading(state, "payment-methods"),
  };
};
